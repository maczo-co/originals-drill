# maczo Originals — Drill · Provably Fair

Welcome. This wiki explains how every **Drill** result on [maczo.co](https://maczo.co) is provably
...
- 🔐 **[The Algorithm](Algorithm)** — the HMAC-SHA256 → uint32 engine + Drill's resolve step
...
- **Live (offline in your browser):** https://verify.maczo.co/originals/?game=drill
- **Source / Node CLI:** https://github.com/maczo-co/originals-drill
- **Published odds:** https://verify.maczo.co/originals/paytables/drill.json
